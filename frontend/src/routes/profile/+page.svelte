    ...
    <main class="max-w-4xl mx-auto p-6">
        <div class="bg-white/5 backdrop-blur-sm rounded-lg p-6">
            ...
            <div class="space-y-4">
				...
				<div class="text-white">
					<strong>USACO Division:</strong> {$user?.usaco_division}
				</div>
				<div class="text-white">
					<strong>Codeforces Handle:</strong> {$user?.cf_handle}
				</div>
            </div>
            <button
                class="mt-6 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded transition-colors"
